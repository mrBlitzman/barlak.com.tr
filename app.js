...
app.use(
  "/statics",
  express.static(__dirname + "/views/partials/statics", {
  ...
  try {
    ...
    if (user) {
      ...
      if (isMatch) {
        ...
        console.log(
          `[User Entry Attempt]: Invalid username or password from IP ${req.ip}`
        );
